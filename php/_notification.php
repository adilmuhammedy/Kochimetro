    ...
    <div class="container">
        ...
        <table>
            ...
            <?php while ($row = $result->fetch_assoc()) { ?>
                <tr>
                    <td id="select"><input type="checkbox" name="selectedRows[]" value="<?php echo $row['id']; ?>"></td>
                    <td id="item-id"><?php echo $row['id']; ?></td>
                    <td id="message"><?php echo $row['message']; ?></td>
                    <td id="dot"><?php echo $row['dateTime']; ?></td>
                    <!-- Add more columns here as needed -->
                </tr>
            <?php } ?>
        </table>
